...
| `LLVM_MOS_GENERATE_LINK_REPORTS` | Boolean | Generate lots of additional information when compiling an executable, including information generated by llvm-readelf, llvm-objdump, and llvm-dwarfdump. |
